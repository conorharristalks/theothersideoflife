      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.div className="prose prose-lg max-w-none space-y-8" variants={itemVariants}>
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Use of the Website</h2>
              
              <div className="mb-6">
                <h3 className="text-xl font-fraunces font-semibold text-white mb-3">Eligibility</h3>
                <p className="font-nunito text-white leading-relaxed">
              ...
              <div className="mb-6">
                <h3 className="text-xl font-fraunces font-semibold text-white mb-3">Permitted Use</h3>
              ...
              <div>
                <h3 className="text-xl font-fraunces font-semibold text-white mb-3">Prohibited Actions</h3>
                <p className="font-nunito text-white leading-relaxed">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Booking Services</h2>
              
              <div className="mb-6">
                <h3 className="text-xl font-fraunces font-semibold text-white mb-3">Discovery Call Bookings (Individual Wellness Coaching or Breathwork Coaching)</h3>
                <p className="font-nunito text-white leading-relaxed">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Intellectual Property</h2>
              <p className="font-nunito text-white leading-relaxed">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Links to Professional Helplines</h2>
              <p className="font-nunito text-white leading-relaxed">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Limitation of Liability</h2>
              <p className="font-nunito text-white leading-relaxed">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Governing Law</h2>
              <p className="font-nunito text-white leading-relaxed">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Changes to the Terms</h2>
              <p className="font-nunito text-white leading-relaxed">
