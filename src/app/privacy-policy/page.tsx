      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="overflow-hidden mb-8">
            <motion.h1
              className="h1 font-fraunces font-bold text-white text-center mb-8"
          ...
          <motion.div className="prose prose-lg max-w-none space-y-8" variants={itemVariants}>
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Introduction</h2>
              <p className="font-nunito text-white leading-relaxed">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Information We Collect</h2>
              
              <div className="mb-6">
                <h3 className="text-xl font-fraunces font-semibold text-white mb-3">Discovery Call Bookings (Individual Wellbeing Coaching or Breathwork Coaching)</h3>
                <p className="font-nunito text-white leading-relaxed mb-3">
                ...
                <ul className="list-disc pl-6 font-nunito text-white space-y-2">
                ...
                <p className="font-nunito text-white leading-relaxed mt-3">
              ...
              <div>
                <h3 className="text-xl font-fraunces font-semibold text-white mb-3">Talk Bookings (with Institutions)</h3>
                <p className="font-nunito text-white leading-relaxed mb-3">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">How We Use Your Information</h2>
              
              <div className="mb-6">
                <h3 className="text-xl font-fraunces font-semibold text-white mb-3">Discovery Call Bookings</h3>
                <p className="font-nunito text-white leading-relaxed mb-3">For discovery calls booked via Calendly:</p>
                <ul className="list-disc pl-6 font-nunito text-white space-y-2">
              ...
              <div>
                <h3 className="text-xl font-fraunces font-semibold text-white mb-3">Talk Bookings</h3>
                <p className="font-nunito text-white leading-relaxed mb-3">For talk bookings processed through our booking system:</p>
                <ul className="list-disc pl-6 font-nunito text-white space-y-2">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Data Sharing</h2>
              <ul className="list-disc pl-6 font-nunito text-white space-y-3">
              ...
              <p className="font-nunito text-white leading-relaxed mt-4">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Data Security</h2>
              <p className="font-nunito text-white leading-relaxed">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Your Rights</h2>
              <ul className="list-disc pl-6 font-nunito text-white space-y-2">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Changes to This Policy</h2>
              <p className="font-nunito text-white leading-relaxed">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Disclaimer</h2>
              <p className="font-nunito text-white leading-relaxed">
            ...
            <section>
              <h2 className="h3 font-fraunces font-bold text-white mb-4">Contact Information</h2>
              <p className="font-nunito text-white leading-relaxed">
